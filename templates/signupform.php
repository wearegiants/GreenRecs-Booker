...
<section class="form-part" id="ContactForm">
    <form role="form" action="<?php echo $this->getFormActionUrl(); ?>" method="POST" enctype="multipart/form-data" class="hidden" id="contact">
    <?php echo $this->getSubmitFields('Signup');?>
        ...
        <div class="question text-center col-md-12 spacer"> 
...
<form role="form" action="<?php echo $this->getFormActionUrl(); ?>" method="POST" enctype="multipart/form-data" class="hidden" id="symptoms">
<?php echo $this->getSubmitFields('Signup');?>
...
<form role="form" action="<?php echo $this->getFormActionUrl(); ?>" method="POST" enctype="multipart/form-data" class="hidden" id="legal">
<?php echo $this->getSubmitFields('Signup');?>
...
<form role="form" action="<?php echo $this->getFormActionUrl(); ?>" method="POST" enctype="multipart/form-data" class="hidden" id="history">
<?php echo $this->getSubmitFields('Signup');?>
...
<form role="form" action="<?php echo $this->getFormActionUrl(); ?>" method="POST" enctype="multipart/form-data" class="hidden" id="agreement">
<?php echo $this->getSubmitFields('Signup');?>
...
<div class="row">
  ...
  <input class="btn btn-primary btn-lg custom" data-form-id="" type="submit" value="Submit" />
  </div>
</div>
</div>
</form>
